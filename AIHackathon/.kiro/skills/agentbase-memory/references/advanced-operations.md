...
**CLI:**
```bash
bash .kiro/skills/agentbase/scripts/memory.sh records generate-from-content mem_abc123 \
...
**CLI:**
```bash
bash .kiro/skills/agentbase/scripts/memory.sh records insert mem_abc123 \
  --namespace "/strategies/strat_1/actors/user-1" \
...
**CLI:**
```bash
bash .kiro/skills/agentbase/scripts/memory.sh records delete mem_abc123 rec_789
```
...
**CLI:**
```bash
bash .kiro/skills/agentbase/scripts/memory.sh events delete mem_abc123 user-1 session-1 evt_456
```
...
**CLI:**
```bash
bash .kiro/skills/agentbase/scripts/memory.sh sessions mem_abc123 user-1
```

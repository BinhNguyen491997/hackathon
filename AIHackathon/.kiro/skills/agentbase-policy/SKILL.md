...
| 401 Unauthorized | Expired or invalid IAM token | Re-obtain token with `bash .kiro/skills/agentbase/scripts/get_token.sh --force`. Confirm `GREENNODE_CLIENT_ID` / `GREENNODE_CLIENT_SECRET` are correct. |

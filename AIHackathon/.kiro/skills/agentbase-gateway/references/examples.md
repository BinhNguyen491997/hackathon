...
bash .kiro/skills/agentbase/scripts/vserver.sh vpcs $PROJECT_ID
bash .kiro/skills/agentbase/scripts/vserver.sh subnets $PROJECT_ID $VPC_ID
bash .kiro/skills/agentbase/scripts/vserver.sh validate-vpc $PROJECT_ID $VPC_ID
```

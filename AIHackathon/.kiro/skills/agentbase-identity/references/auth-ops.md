...
**Script**: `bash .kiro/skills/agentbase/scripts/auth.sh` (handles authentication, token refresh, response redaction, and error handling automatically)
...
bash .kiro/skills/agentbase/scripts/auth.sh apikey create --name openai-key --apikey-env OPENAI_API_KEY

# Or from file
bash .kiro/skills/agentbase/scripts/auth.sh apikey create --name openai-key --apikey-file .secrets/openai.key
```
...
**CLI**:
```bash
bash .kiro/skills/agentbase/scripts/auth.sh apikey list --page 0 --size 20
```
...
**CLI**:
```bash
bash .kiro/skills/agentbase/scripts/auth.sh apikey get --name openai-key
```
...
**CLI**:
```bash
bash .kiro/skills/agentbase/scripts/auth.sh apikey update --name openai-key --apikey-env OPENAI_API_KEY
```
...
**CLI**:
```bash
bash .kiro/skills/agentbase/scripts/auth.sh apikey delete --name openai-key
```
...
**CLI**:
```bash
bash .kiro/skills/agentbase/scripts/auth.sh apikey get-key --provider openai-key --identity my-agent
```
...
**CLI**:
```bash
bash .kiro/skills/agentbase/scripts/auth.sh delegated create --name user-openai-key
```
...
**CLI**:
```bash
bash .kiro/skills/agentbase/scripts/auth.sh delegated list
```
...
**CLI**:
```bash
bash .kiro/skills/agentbase/scripts/auth.sh delegated get --name user-openai-key
```
...
**CLI**:
```bash
bash .kiro/skills/agentbase/scripts/auth.sh delegated delete --name user-openai-key
```
...
**CLI**:
```bash
bash .kiro/skills/agentbase/scripts/auth.sh delegated get-key --provider user-openai-key --identity my-agent --agent-user-id user123 --return-url "https://example.com/callback"
```
...
**CLI**:
```bash
bash .kiro/skills/agentbase/scripts/auth.sh oauth2 create --name google-oauth \
...
**CLI**:
```bash
bash .kiro/skills/agentbase/scripts/auth.sh oauth2 list
```
...
**CLI**:
```bash
bash .kiro/skills/agentbase/scripts/auth.sh oauth2 get --name google-oauth
```
...
**CLI**:
```bash
bash .kiro/skills/agentbase/scripts/auth.sh oauth2 update --name google-oauth \
...
**CLI**:
```bash
bash .kiro/skills/agentbase/scripts/auth.sh oauth2 delete --name google-oauth
```
...
**CLI**:
```bash
bash .kiro/skills/agentbase/scripts/auth.sh oauth2 get-m2m-token --provider google-oauth --identity my-agent --scopes "scope1,scope2"
```
...
**CLI**:
```bash
bash .kiro/skills/agentbase/scripts/auth.sh oauth2 get-3lo-token --provider google-oauth --identity my-agent --agent-user-id user123 --return-url "https://example.com/callback" --scopes "scope1,scope2"
```

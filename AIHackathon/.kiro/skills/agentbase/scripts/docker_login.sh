...
#
# Usage:
#   bash .kiro/skills/agentbase/scripts/docker_login.sh --credentials-file ./docker-creds.json
#   bash .kiro/skills/agentbase/scripts/docker_login.sh --registry REGISTRY --username USER --password-stdin
#   bash .kiro/skills/agentbase/scripts/docker_login.sh --registry REGISTRY --username USER --password-file /tmp/pass.txt
#

...
#   bash .kiro/skills/agentbase/scripts/check_credentials.sh registry <path-to-credentials-file>
#   bash .kiro/skills/agentbase/scripts/check_credentials.sh registry --credentials-file <path>
#   bash .kiro/skills/agentbase/scripts/check_credentials.sh llm
#   bash .kiro/skills/agentbase/scripts/check_credentials.sh aip  # alias for llm
#

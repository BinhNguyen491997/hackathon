...
All operations use the OpenClaw script: `bash .kiro/skills/agentbase/scripts/openclaw.sh`
...
bash .kiro/skills/agentbase/scripts/openclaw.sh create \
  --name my-tele-bot \
  --flavor 2x4-general \
  --maas-enabled true \
...
```bash
bash .kiro/skills/agentbase/scripts/openclaw.sh list --page 1 --size 20
```
...
```bash
bash .kiro/skills/agentbase/scripts/openclaw.sh get $OPENCLAW_ID
```
...
```bash
bash .kiro/skills/agentbase/scripts/openclaw.sh stop  $OPENCLAW_ID
bash .kiro/skills/agentbase/scripts/openclaw.sh start $OPENCLAW_ID
```
...
```bash
bash .kiro/skills/agentbase/scripts/openclaw.sh update-version $OPENCLAW_ID \
...
```bash
bash .kiro/skills/agentbase/scripts/openclaw.sh delete $OPENCLAW_ID
```
...
```bash
bash .kiro/skills/agentbase/scripts/openclaw.sh versions
```
